...
import { RECORD_PURCHASE } from "@/lib/graphql/mutations";
import {
    Plus, AlertTriangle, CheckCircle, Layers,
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        <div>
                            ...
                            <div style={{ fontSize: 11, color: "var(--muted)" }}>Stock IN — add inventory</div>
                        </div>
                    </div>
                ...
                <form onSubmit={submit}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 20 }}>
                        <div className="form-group">
                            ...
                            <input className="input" value={supplier.supplierName}
                                onChange={e => setSupplier({ ...supplier, supplierName: e.target.value })}
                                placeholder="ABC Wholesalers" required />
                        </div>
                        <div className="form-group">
                            <label>Invoice # (optional)</label>
                            <input className="input" value={supplier.supplierInvoice}
                                onChange={e => setSupplier({ ...supplier, supplierInvoice: e.target.value })}
                            ...
                            {items.map((item, idx) => (
                                <div key={idx} style={{
                                    ...
                                    <select className="input" style={{ fontSize: 13 }}
                                        value={item.productId} onChange={e => setItem(idx, "productId", e.target.value)} required>
                                    ...
                                    <button type="button" onClick={() => removeItem(idx)}
                                        ...
                                        style={{
                                            ...
                                            color: "#ef4444", opacity: items.length === 1 ? 0.2 : 0.7,
                                            display: "flex", alignItems: "center", justifyContent: "center",
                                        }}
                    ...
                    <div className="form-group" style={{ marginBottom: 24 }}>
                        ...
                        <input className="input" value={supplier.notes}
                            onChange={e => setSupplier({ ...supplier, notes: e.target.value })}
                            placeholder="e.g. Seasonal restocking" />
                    </div>
                    ...
                    <div style={{ display: "flex", gap: 10 }}>
                        ...
                        <button type="submit" className="btn btn-primary" style={{
                            ...
                            {loading
                                ? <><Loader2 size={14} style={{ animation: "spin 0.7s linear infinite" }} /> Recording…</>
        ...
        <tr>
            ...
            <td>
                <span style={{
                    ...
                    padding: "2px 8px", borderRadius: 6, color: "var(--muted)",
                }}>
                    {l.sku}
                </span>
            </td>
            ...
            <td>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <span style={{
                        ...
                        color: l.isLowStock ? "#fbbf24" : "var(--text)",
                        minWidth: 48,
                    }}>
                        {fmt(l.currentStock)}
                    </span>
...
export default function StockPage() {
    ...
    const okStock = levels.filter((l: any) => !l.isLowStock);
                ...
                <div className="table-wrapper">
                    <table className="data-table">
                        ...
                        <tbody>
                            ...
                            {levels.map((l: any) => <StockRow key={l.productId} l={l} />)}
                        </tbody>
                    </table>
                </div>
